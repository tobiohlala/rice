...
///--Menus and Programs---///
static const char *menucmd[]   = { "dmenu_run", "-b", "-fn", "ProFont:style=regular:size=8", "-nb", "#262626", "-nf", "#d6334f", "-sb", "#d6334f", "-sf", "#262626", NULL };
...
static key keys[] = {
    ...
    {  0x000000,          0x1008ff02,    start,             {.com = lum_up}},
    {  0x000000,          0x1008ff03,    start,             {.com = lum_down}},
